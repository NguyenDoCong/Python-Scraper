...
def save_cookies(video_url, cookies_filename="cookies.json", user_agent_filename="user_agent.txt"):
...
def get_url(video_url, is_music=True, cookies_filename="cookies.json", user_agent_filename="user_agent.txt"):
    try:
...
def main(link, is_music=True, cookies_filename="cookies.json", user_agent_filename="user_agent.txt"):
